...
#FINAL OUTPUT
write.csv(rep5_df, "./output/ReplicateDF_Q5.csv", row.names=FALSE)
...
#FINAL OUTPUT
write.csv(rep6_df, "./output/ReplicateDF_Q6.csv", row.names=FALSE)

#Generating and saving the plot
plot6 <- ggplot(rep6_df, aes(x = year, y = gini)) + 
       geom_line()
ggsave('./output/plot_6.jpg')
